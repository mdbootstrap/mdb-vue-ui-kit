<template>
  <container>
    <row class="mt-5 align-items-center justify-content-start">
      ...
      <a href="https://mdbootstrap.com/docs/vue/advanced/carousel/#video/?utm_source=DemoApp&utm_medium=MDBVueFree" waves-fixed class="border grey-text px-2 border-light rounded ml-2" target="_blank"><fa icon="graduation-cap" class="mr-2"/>Docs</a>
    </row>
    <hr class="mb-4" />
