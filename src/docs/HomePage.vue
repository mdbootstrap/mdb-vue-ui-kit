          ...
          <column md="10" class="mx-auto float-none white z-depth-1 py-2 px-2">
            <card-body>
              ...
              <row class="d-flex flex-row justify-content-center">
                <a href="https://mdbootstrap.com/docs/vue/?utm_source=DemoApp&utm_medium=MDBVue" waves-fixed class="border nav-link border-light rounded mr-1" target="_blank"><fa icon="graduation-cap" class="mr-2"/>Official documentation</a>
